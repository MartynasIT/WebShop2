	...
	<div class="header">
		<div class="headertop_desc">
			<div class="account_desc">
					...
					<?php 
					if(!isset($_SESSION['email'])){echo "<li><a href='/user/register'>Register</a></li>"; } else echo ""; ?>
							...
							<?php if(!isset($_SESSION['email'])){echo "<li><a href='/shop/wishlist'>Wishlist</a></li>"; } else echo "<li><a href='/shop/wishlist'>Wishlist</a></li>"; ?>
						</ul>
			</div>
			<div class="clear"></div>
		</div>
